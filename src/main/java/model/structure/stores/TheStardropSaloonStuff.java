...
public enum TheStardropSaloonStuff implements Shop {
	...
	HASHBROWNS_RECIPE(new CookingRecipe("hashbrowns recipe","A recipe to make Hashbrowns",50),50,1),
	OMELET_RECIPE(new CookingRecipe("omelet recipe","A recipe to make Omelet",100),100,1),
	PANCAKES_RECIPE(new CookingRecipe("pancakes recipe","A recipe to make Pancakes",100),100,1),
	BREAD_RECIPE(new CookingRecipe("bread recipe","A recipe to make Bread",100),100,1),
	TORTILLA_RECIPE(new CookingRecipe("tortilla recipe","A recipe to make Tortilla",100),100,1),
	PIZZA_RECIPE(new CookingRecipe("pizza recipe","A recipe to make Pizza",150),150,1),
	MAKI_ROLL_RECIPE(new CookingRecipe("maki roll recipe","A recipe to make Maki Roll",300),300,1),
	TRIPLE_SHOT_ESPRESSO_RECIPE(new CookingRecipe("triple shot espresso recipe","A recipe to make Triple Shot Espresso",5000),5000,1),
	COOKIE_RECIPE(new CookingRecipe("cookie recipe","A recipe to make Cookie",300),300,1);
