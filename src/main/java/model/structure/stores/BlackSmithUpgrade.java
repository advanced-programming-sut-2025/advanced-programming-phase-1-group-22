...
public enum BlackSmithUpgrade {
	...
	COPPER_TRASHCAN(TrashCan.CUPPER,Map.of(MadeProductType.COPPER_BAR,5),2000,1),
	COPPER_WATER_CAN(WateringCan.CUPPER,Map.of(MadeProductType.COPPER_BAR,5),2000,1),
	COPPER_TRASH_CAN(TrashCan.CUPPER,Map.of(MadeProductType.COPPER_BAR,5),1000,1),
	...
	STEEL_WATER_CAN(WateringCan.IRON,Map.of(MadeProductType.IRON_BAR,5),5000,1),
	...
	GOLD_WATER_CAN(WateringCan.GOLD,Map.of(MadeProductType.GOLD_BAR,5),10000,1),
	...
	IRIDIUM_WATER_CAN(WateringCan.IRIDIUM,Map.of(MadeProductType.IRIDIUM_BAR,5),25000,1),
