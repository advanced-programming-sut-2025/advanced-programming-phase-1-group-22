...
public abstract class GameMenu implements CommandProcessor {
    ...
    public Map<CommandClass, Function<String[], Response>> getFunctionsMap() {
        ...
        commandsFunctionMap.put(energyShow, controller::energyShow);
        commandsFunctionMap.put(C_EnergyUnlimited, controller::C_EnergyUnlimited);
        commandsFunctionMap.put(inventoryShow, controller::inventoryShow);
        commandsFunctionMap.put(toolsShowCurrent, controller::toolsShowCurrent);
        commandsFunctionMap.put(toolsShowCAvailable, controller::toolsShowCAvailable);
        commandsFunctionMap.put(C_EnergySet, controller::C_EnergySet);
        commandsFunctionMap.put(inventoryTrash, controller::inventoryTrash);
        commandsFunctionMap.put(toolsEquip, controller::toolsEquip);
        commandsFunctionMap.put(toolsUpgrade, controller::toolsUpgrade);
        commandsFunctionMap.put(toolsUse, controller::toolsUse);
