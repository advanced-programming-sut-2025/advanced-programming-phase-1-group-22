...
public class Crop extends HarvestAbleProduct implements Source {
    ...
    private transient Sprite giantSprite;
    ...
    private void init() {
        ...
        this.sprite.setSize(App.tileWidth / 2f, App.tileHeight / 2f);
        if (this.cropType.isCanBecomeGiant()) {
            this.giantSprite = new Sprite(this.cropType.getGiantTexture());
            this.giantSprite.setSize(App.tileWidth * 2, App.tileWidth * 2);
        }
    }
}
