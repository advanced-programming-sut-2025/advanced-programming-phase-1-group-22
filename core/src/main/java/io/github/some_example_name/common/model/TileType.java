...
public enum TileType {
    ...
    PATH(GameAsset.PATH_FLOOR), FENCE(GameAsset.STONE_FENCE), DOOR(GameAsset.GATE), PLOWED(GameAsset.PLOWED_FLOORING),
    THUNDERED(GameAsset.THUNDERED_FLOOR), FERTILIZED(GameAsset.FLOORING_59);
