...
public enum SundryType implements SalableIntegration {
    ...
    DELUXE_RETAINING_SOIL("Deluxe Retaining Soil",150 / 2,null),
    QUALITY_RETAINING_SOIL("Quality Retaining Soil",150 / 2,null),
    BASIC_RETAINING_SOIL("Basic Retaining Soil",100 / 2,null),
