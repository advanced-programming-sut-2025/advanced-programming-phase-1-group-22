...
public enum TrashCan implements Tool {
    NORMAL("normal trashcan", 0, 0, 0,new Sprite(GameAsset.WORM_BIN)),
    COPPER("copper trashcan", 1, 15, 2000 / 2,new Sprite(GameAsset.TRASH_CAN_COPPER)),
    IRON("iron trashcan", 2, 30, 5000 / 2,new Sprite(GameAsset.TRASH_CAN_STEEL)),
    GOLD("gold trashcan", 3, 45, 10000 / 2,new Sprite(GameAsset.TRASH_CAN_GOLD)),
    IRIDIUM("iridium trashcan", 4, 60, 25000 / 2,new Sprite(GameAsset.TRASH_CAN_IRIDIUM));
    ...
    TrashCan(String name, int level, int prunedValue, int price,Sprite sprite) {
        this.name = name;
        this.level = level;
